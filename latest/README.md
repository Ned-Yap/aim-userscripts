...
- [Latest - AIM Map Nav](https://raw.githubusercontent.com/Ned-Yap/aim-userscripts/main/latest/AIM_Map_Nav.user.js) — **NEW (dev-only)**: WASD pan · Q/E zoom · Shift sprint · Ctrl precise. Always-on, input-guarded. No prod counterpart yet.
