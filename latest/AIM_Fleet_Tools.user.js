...
(function () {
    ...
    function puAggregate(flights, tz, shiftHrs, ctx) {
        ...
        const byPilotF = {}; flights.forEach(f => { f.one = !!puRuleOf(f.sid).one; f.viol = false; f.nightMs = 0; (byPilotF[f.pilot] = byPilotF[f.pilot] || []).push(f); });
