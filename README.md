...
| 11 | **AIM Performance Shield** (blocks session-replay + chat + weather network traffic; optional hide-satellite / ortho low-res for slow hardware) | [Install](https://raw.githubusercontent.com/Ned-Yap/aim-userscripts/main/AIM_Perf_Shield.user.js) |
| 12 | **AIM Mission Bank Tools** (SUM button → Mission Summary panel with sortable/filterable table of all missions on the site; click any row → drill-down with per-step instructions, ground elevation + AGL, inline altitude editor with batch commit, KML export of GPS pins; right-click any mission row → quick stats popup) | [Install](https://raw.githubusercontent.com/Ned-Yap/aim-userscripts/main/AIM_Mission_Bank_Tools.user.js) |
| 13 | **AIM Quick Mission Editor** (bulk-reorder mission instructions — Ctrl+Click drag handles to select, Enter to open move dialog) | [Install](https://raw.githubusercontent.com/Ned-Yap/aim-userscripts/main/AIM_Quick_Mission_Editor.user.js) |
| 14 | **AIM Power Line Editor** (⚡ button in map toolbar — drives Map Styler's vertex-edit / draw / delete-line / branch-from-vertex / snap-to-vertex modes for editing distro + trans KML files in-place; commits to GitHub) | [Install](https://raw.githubusercontent.com/Ned-Yap/aim-userscripts/main/AIM_Power_Line_Editor.user.js) |
